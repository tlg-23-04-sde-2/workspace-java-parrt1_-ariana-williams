...
//         testParse();
    ...
    public static void testCreate() {
        ...
        LocalDate bday = LocalDate.of(1992, 04, 02);
        System.out.println(bday);

        // TO use of() to create a value representing the 1st lunar landing - it happened on 7/20/69 at 3:18pm Eastern Time.
    ...
    public static void testParse() {
        ...
        LocalDate bday = LocalDate.parse("1992-04-02");
        System.out.println(bday);
